    ...
    {listings && listings.map((aListing, index) => {
      if(index % 4 === 0 && index + 3 < listings.length) {
        rowArray.push (<Row xs={1} md={2} lg={4}>
          <Col>
          <Listing instantChange={callAPI} user={user} userInfo={userInfo} listingId={aListing.listingId} title={aListing.title} price={aListing.price} postDate={aListing.creationTime} pictures={aListing.pictures}/>          </Col>
          <Col>
          <Listing instantChange={callAPI} user={user} userInfo={userInfo} listingId={listings[index + 1].listingId} title={listings[index + 1].title} price={listings[index + 1].price} postDate={listings[index + 1].creationTime} pictures={listings[index + 1].pictures}/>
          </Col>
          <Col>
          <Listing instantChange={callAPI} user={user} userInfo={userInfo} listingId={listings[index + 2].listingId} title={listings[index + 2].title} price={listings[index + 2].price} postDate={listings[index + 2].creationTime} pictures={listings[index + 2].pictures}/>
          </Col>
          <Col>
          <Listing instantChange={callAPI} user={user} userInfo={userInfo} listingId={listings[index + 3].listingId} title={listings[index + 3].title} price={listings[index + 3].price} postDate={listings[index + 3].creationTime} pictures={listings[index + 3].pictures}/>
          </Col>
          </Row>)
        ...
        rowArray.push(
        <Row xs={1} md={2} lg={4}>
             <Listing instantChange={callAPI} user={user} userInfo={userInfo} listingId={aListing.listingId} title={aListing.title} price={aListing.price} postDate={aListing.creationTime} pictures={aListing.pictures}/>
        </Row>)
...
>>>>>>> 55e627814b902b44a6533a0728e07ff8efe3127b
        </Row>)
